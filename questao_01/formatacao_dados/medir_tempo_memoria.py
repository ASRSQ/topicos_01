import time
import tracemalloc
from geraRelatorio import gerar_relatorio
from gerarGrafico import gerar_grafico_e_salvar


def medir_tempo_memoria(num_repeticoes, codigo, codigo_arg, nomeArquivo, nomeGDiretorio, nomeRDiretorio):
    ...
    for _ in range(num_repeticoes):
        ...
        iteracoes = codigo(codigo_arg)  # Executa o trecho de código fornecido
